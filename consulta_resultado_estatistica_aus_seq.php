...
$sql  = "Select nr_conc, b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15 FROM concurso 
         WHERE nr_conc >=".($result-10)." and nr_conc <=".($result-1);
$query = $mysqli->query($sql);

$sql10  = "Select nr_conc, b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15 FROM concurso 
         WHERE nr_conc =".$result;
$query10 = $mysqli->query($sql10);
$dados10 = $query10->fetch_array();


while ($dados = $query->fetch_array()) {
  echo '<br>'.$dados['nr_conc'] ;
  echo '-'.$dados['b1'] ;
  echo '-'.$dados['b2'] ;
  echo '-'.$dados['b3'] ;
  echo '-'.$dados['b4'] ;
