...
echo "<br><br>Iniciando Analise <br>";
	for ($ii=1; $ii<26;$ii++)
	{
		$sql2  = "Select nr_regra FROM regras_consolidada
				 WHERE  jogo1 = '".$valor[$ii][1]."' and jogo2 = '".$valor[$ii][2]."' and jogo3 = '".$valor[$ii][3]."' and jogo4 = '".$valor[$ii][4]."' and jogo5 = '".$valor[$ii][5]."' and jogo6 = '".$valor[$ii][6].
		...
		if(mysqli_affected_rows($mysqli) == 0){
			...
			echo " <br> enquadrou na  regra ".$dados2['nr_regra']."<br>";
