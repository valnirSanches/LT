														...
														for($cont13 = 13; $cont13 < 24; $cont13++)
														{
															...
															continue;
																...
																continue;
														      		...
														      		for($cont16 = 16; $cont16 < 26; $cont16++)
																    {
																        if($cont16 <= $cont15)
																    {
																        continue;
																	...
																	if(($cont2 > $cont)  and ($cont3 > $cont2) and ($cont4 > $cont3) and ($cont5 > $cont4) and
																	    ...
																	    ($cont13 > $cont12)and ($cont14 > $cont13)and ($cont15 > $cont14)and ($cont16 > $cont15))
																	{
																		$ID++;
																		echo $ID.'<\br>';
																		fwrite($ponteiro, $ID.";".$cont.";".$cont2.";".$cont3.";".$cont4.";"
																		.$cont5.";".$cont6.";".$cont7.";".$cont8.";".$cont9.";"
																		.$cont10.";".$cont11.";".$cont12.";".$cont13.";".$cont14.";".$cont15.";"
																		.$cont16.";"."\n");	
																	}					
