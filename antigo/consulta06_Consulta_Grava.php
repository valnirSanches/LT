...
$mysqli = new mysqli('localhost', 'root', '', 'lf');
...
$sql  = "Select concurso, bola01,bola02,bola03,bola04,bola05,bola06,bola07,bola08,bola09,bola10,bola11,bola12,bola13,bola14,bola15 FROM resultado 
         WHERE concurso >=".($result-10)." and concurso <=".($result-1);
$query = $mysqli->query($sql);

$sql10  = "Select concurso, bola01,bola02,bola03,bola04,bola05,bola06,bola07,bola08,bola09,bola10,bola11,bola12,bola13,bola14,bola15 FROM resultado 
         WHERE concurso =".$result;
$query10 = $mysqli->query($sql10);
$dados10 = $query10->fetch_array();


while ($dados = $query->fetch_array()) {
  echo '<br>'.$dados['concurso'] ;
  echo '-'.$dados['bola01'] ;
  echo '-'.$dados['bola02'] ;
  echo '-'.$dados['bola03'] ;
  echo '-'.$dados['bola04'] ;
...
echo "<br><br>Iniciando Analise <br>";
	for ($ii=1; $ii<26;$ii++)
	{
		$sql2  = "Select nr_regra, in_sair, qt_saiu FROM regras 
				 WHERE qt_repetiu = ".$qt[$ii][1]." and jogo01 = '".$valor[$ii][1]."' and jogo02 = '".$valor[$ii][2].
		...
		if(mysqli_affected_rows($mysqli) == 0){
			...
			if($dados2['in_sair']=='S'){
				...
				echo "$ii-".$qt[$ii][1];		
				echo "-".$dados2['in_sair']."-".$dados2['qt_saiu']."<br>";
			}		
